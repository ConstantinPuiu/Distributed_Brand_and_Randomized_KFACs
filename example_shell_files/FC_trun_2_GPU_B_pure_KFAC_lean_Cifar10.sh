...
OMP_NUM_THREADS=8 torchrun --standalone --nnodes 1 --nproc_per_node=2 /home/chri5570/Distributed_Brand_and_Randomized_KFACs/main_files/CIFAR10/n_GPUs_dist_B_pure_KFAC_torchrun_lean_KFACTORS_CIFAR_10.py --world_size 2 --n_epochs 10 --brand_update_multiplier_to_TCov 5 --work_alloc_propto_RSVD_and_B_cost 1 --net_type 'FC' --truncate_before_inversion 1
