...
OMP_NUM_THREADS=8 torchrun --standalone --nnodes 1 --nproc_per_node=2 /home/chri5570/Distributed_Brand_and_Randomized_KFACs/main_files/main_measuring_rNLA_error.py --world_size 2 --n_epoch 20 --batch_size 128 \
...
--store_and_save_metrics 0 --metrics_save_path '/data/math-opt-ml/saved_metrics/' \
...
--Kfactor_spectrum_savepath '/data/math-opt-ml/saved_rNLA_errors/' --Network_scalefactor 1
