...
OMP_NUM_THREADS=8 torchrun --standalone --nnodes 1 --nproc_per_node=4 /home/chri5570/Distributed_Brand_and_Randomized_KFACs/main_files/main_measuring_Kfactors_spectrums.py --world_size 4 --n_epoch 20 --batch_size 128 \
