...
#SBATCH --job-name=scf4_2G
#SBATCH --nodes=1
#SBATCH --gres=gpu:2 --constraint='gpu_sku:RTX8000'
...
OMP_NUM_THREADS=8 torchrun --standalone --nnodes 1 --nproc_per_node=2 /home/chri5570/Distributed_Brand_and_Randomized_KFACs/main_files/main_measuring_Kfactors_spectrums.py --world_size 2 --n_epoch 30 --batch_size 128 \
...
--Kfactor_spectrum_savepath '/data/math-opt-ml/saved_eigenspectrums/' --Network_scalefactor 4
