...
OMP_NUM_THREADS=8 torchrun --standalone --nnodes 1 --nproc_per_node=1 /home/chri5570/Distributed_Brand_and_Randomized_KFACs/main_files/CIFAR10/n_GPUs_dist_B_R_C_KFAC_torchrun_lean_KFACTORS_CIFAR_10.py --world_size 1 --n_epochs 5 --batch_size 256 \
--net_type 'resnet18' \
