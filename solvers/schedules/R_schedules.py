...
TInv_schedule_flag = {0: 100, 5: 50}

# Used by : R, B, B-R, B-R-C
TCov_schedule_flag = {0: 20, 5: 10}
...
# Used by : B, B-R, B-R-C
#brand_update_multiplier_to_TCov_schedule_flag = {0: 5, 5: 1}

# Used by : B-R, B-R-C
#B_R_period_schedule_flag = {0 : 5, 5: 2}

# Used by : B-R-C
#correction_multiplier_TCov_schedule_flag = {0:5, 5: 2}
