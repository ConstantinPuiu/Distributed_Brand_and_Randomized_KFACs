...
class KFACOptimizer_measuring_spectrum(optim.Optimizer):
    def __init__(self,
                 model,
                 ...
                 Kfactor_spectrum_savepath = './',
                 Network_scalefactor = 1):
        ...
        super(KFACOptimizer_measuring_spectrum, self).__init__(model.parameters(), defaults)
        ...
        self.Kfactor_spectrum_savepath = Kfactor_spectrum_savepath
        self.Network_scalefactor = Network_scalefactor
        self.raw_aa = {}; self.raw_gg = {}
        self.layer_number = {}; self.layer_type = {}
        # save filename: self.Kfactor_spectrum_savepath + '/espectrum_raw_kfactor_A_netScaleFactor_{}_layer_{}_iter_{}'.format(Network_scalefactor, layer_number, layer_type, self.steps)
        # save filename: self.Kfactor_spectrum_savepath + '/espectrum_raw_kfactor_G_netScaleFactor_{}_layer_{}_iter_{}'.format(Network_scalefactor, layer_number, layer_type, self.steps)
        # save filename: self.Kfactor_spectrum_savepath + '/espectrum_EA_kfactor_A_netScaleFactor_{}_layer_{}_iter_{}'.format(Network_scalefactor, layer_number, layer_type, self.steps)
        # save filename: self.Kfactor_spectrum_savepath + '/espectrum_EA_kfactor_G_netScaleFactor_{}_layer_{}_iter_{}'.format(Network_scalefactor, layer_number, layer_type, self.steps)
    ...
    def _do_evd_of_raw_kfactor_and_save(self, m):
        ...
        if m in self.modules_for_this_rank_A[self.rank]:
            ...
            filename = self.Kfactor_spectrum_savepath \
                        + '/espectrum_raw_kfactor_A_netScaleFactor_{}_layer_{}_LayerType_{}_iter_{}.pt'.format(
                        self.Network_scalefactor, self.layer_number[m], self.layer_type[m], self.steps)
            torch.save(raw_da, filename)
        ...
        if m in self.modules_for_this_rank_G[self.rank]:  
            ...
            filename = self.Kfactor_spectrum_savepath \
                        + '/espectrum_raw_kfactor_G_netScaleFactor_{}_layer_{}_LayerType_{}_iter_{}.pt'.format(
                        self.Network_scalefactor, self.layer_number[m], self.layer_type[m], self.steps)
            torch.save(raw_dg, filename)
    ...
    def _update_inv(self, m):
        ...
        if m in self.modules_for_this_rank_A[self.rank]:
            ...
            ##### save eigenspectrum of EA Kfactor mathcal A ########
            filename = self.Kfactor_spectrum_savepath \
                        + '/espectrum_EA_kfactor_A_netScaleFactor_{}_layer_{}_LayerType_{}_iter_{}.pt'.format(
                        self.Network_scalefactor, self.layer_number[m], self.layer_type[m], self.steps)
            torch.save(self.d_a[m], filename)
        ...
        if m in self.modules_for_this_rank_G[self.rank]:  
            ...
            ##### save eigenspectrum of EA Kfactor Gamma ################
            filename = self.Kfactor_spectrum_savepath \
                        + '/espectrum_EA_kfactor_G_netScaleFactor_{}_layer_{}_LayerType_{}_iter_{}.pt'.format(
                        self.Network_scalefactor, self.layer_number[m], self.layer_type[m], self.steps)
    ...
    def step(self, epoch_number, error_savepath, closure = None):
        ...
        if self.steps % self.TCov == 0: # then do EVD of raw K-factors s.t. we save tehir spectrum
            for m in self.modules:
                self._do_evd_of_raw_kfactor_and_save(m)
