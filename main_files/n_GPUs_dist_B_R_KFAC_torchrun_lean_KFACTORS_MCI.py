...
def main(world_size, args):
    ...
    if rank == 0 and args.store_and_save_metrics:
        ...
        stored_metrics_object.save_metrics( metrics_save_path = args.metrics_save_path, dataset = args.dataset, 
                                           net_type = args.net_type, solver_name = 'BR', nGPUs = args.world_size,
    ...
    print('######### Finished Running BR-KFAC at seed = {} ######################################################'.format(args.seed))
...
if __name__ == '__main__':
    ...
    print('\n ######### Started Running BR-KFAC at seed = {} ######################################################'.format(args.seed))
