...
from Distributed_Brand_and_Randomized_KFACs.solvers.distributed_kfac_lean_Kfactors_batchsize_measuring_rNLA_error import KFACOptimizer_measuring_rNLA_error
...
def main(world_size, args):
    ...
    savepath_rnla_error = args.Kfactor_spectrum_savepath#defauls is #'./'
    ...
    optimizer =  KFACOptimizer_measuring_rNLA_error(
                                ...
                                savepath_rnla_error = savepath_rnla_error,
                                rel_tr_err = 0.033)#   
...
if __name__ == '__main__':
    ...
    print('\n ######### Started Running K-FAC at seed = {} : saving rNLA error ######################################################'.format(args.seed))
    print('\nStarted again, Current Time = {} \n for KFAC lean\n'.format(now_start))
