...
def parse_args():
    ...
    parser.add_argument('--correction_multiplier_TCov_period_schedule_flag', type=int, default = 0, help='Set to any non-zero integer if we want to use the correction_multiplier_TCov_period_schedule (schedule dict for correction_multiplier_TCov_period) from solver/schedules/BRC_schedules.py . Note: correction_multiplier_TCov_period multiplies TInv to get how many iterations between an R-update to B-Layers (ie LL layers)' ) 
...
if __name__ == '__main__':
    ...
    print('\nScheduling flags were: \n --TInv_schedule_flag = {}, --TCov_schedule_flag = {},\n --brand_update_multiplier_to_TCov_schedule_flag = {}, --B_R_period_schedule_flag = {},\n --correction_multiplier_TCov_period_schedule_flag = {},\n--KFAC_damping_schedule_flag = {}'.format(args.TInv_schedule_flag, args.TCov_schedule_flag, args.brand_update_multiplier_to_TCov_schedule_flag, args.B_R_period_schedule_flag, args.correction_multiplier_TCov_period_schedule_flag, args.KFAC_damping_schedule_flag))
